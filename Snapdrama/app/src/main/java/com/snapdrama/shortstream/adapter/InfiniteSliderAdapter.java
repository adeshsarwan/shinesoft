...
public class InfiniteSliderAdapter extends RecyclerView.Adapter<InfiniteSliderAdapter.SliderViewHolder> {
    ...
    public InfiniteSliderAdapter(List<SliderItemModel> sliderItemModels) {

...
public class OnBoard3ThreeNativeAdView {
    ...
    public static void displayNativeBottomId(Context context, List<String> nativeAdsIds, final LinearLayout linearLayout, ShimmerFrameLayout shimmerFrameLayout) {
...
//                android.util.Log.d("SplashNativeAd", "No more Native Ad IDs to request or list is empty. Resetting index.");
    ...
    public static void loadAdmobBigNativeAd(final Context context, List<String> nativeAdsIds, final LinearLayout linearLayout) {
        ...
        if (nativeAdsIds == null || nativeAdsIds.isEmpty()) {
            return;
        }

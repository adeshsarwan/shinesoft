...
namespace BizzyBeeGames
{
	public class ScreenManager : SingletonComponent<ScreenManager>
	{
		...
		public GameObject launchLoadingCanvas;

		public void ShowHomeScreen()
		{
			Debug.Log("[ScreenManager] ShowHomeScreen called");
			if (launchLoadingCanvas != null) launchLoadingCanvas.SetActive(false);
			Show(homeScreenId, false, true);
			Debug.Log("[ScreenManager] ShowHomeScreen Show() returned");
		}
		...
		private void Show(string screenId, bool back, bool immediate)
		{
			...
			GoogleAdsManager.Instance.ShowNativeAd();

...
public class share : MonoBehaviour
{
 ...
 private static extern void sampleTextMethod (string message);
    ...
    IEnumerator ShareAndroidText()
    {
        ...
        intentObject.Call<AndroidJavaObject>("putExtra", intentClass.GetStatic<string>("EXTRA_SUBJECT"), apiData.shareURL);
        //intentObject.Call<AndroidJavaObject>("putExtra", intentClass.GetStatic<string>("EXTRA_TITLE"), "Text Sharing ");
        intentObject.Call<AndroidJavaObject>("putExtra", intentClass.GetStatic<string>("EXTRA_TEXT"), apiData.shareURL);

...
namespace BizzyBeeGames
{
	public class ToggleSlider : UIMonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
	{
        ...
        [SerializeField] private Image			handleimg			= null;
        ...
        [SerializeField] private Sprite         toggleBgOnIMG         = null;
        [SerializeField] private Sprite         toggeleBgOffIMG        = null;
        [SerializeField] private Sprite         handleOnIMG1= null;
        [SerializeField] private Sprite         handleOffIMG1 = null;
		...
		private void SetUI(float t)
		{
			...
			if (t ==1)
			{
				this.gameObject.GetComponent<Image>().sprite = toggleBgOnIMG;
				handleimg.sprite = handleOnIMG1;
			 }
			else
			{
                this.gameObject.GetComponent<Image>().sprite = toggeleBgOffIMG;
                handleimg.sprite = handleOffIMG1;
            }
